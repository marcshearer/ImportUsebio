    ...
    fileprivate static let themes: [ThemeName : ThemeConfig] = [
        .standard : ThemeConfig(
            background: [
                ...
                .alternateBannerButton       : ThemeColor(#colorLiteral(red: 0.6286649108, green: 0.6231410503, blue: 0.6192827821, alpha: 1), #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), .lightBackground, .darkBackground),
                ...
                .background                  : ThemeColor(#colorLiteral(red: 0.9411764706, green: 0.9411764706, blue: 0.9411764706, alpha: 1), #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), .lightBackground, .darkBackground),
                ...
                .tile                        : ThemeColor(#colorLiteral(red: 0.6512467894, green: 0.8691673801, blue: 0.8686322774, alpha: 1), #colorLiteral(red: 0.2, green: 0.2, blue: 0.2, alpha: 1), .midBackground, .darkBackground),
                .highlightTile               : ThemeColor(#colorLiteral(red: 0.5019607843, green: 0.7077345429, blue: 0.7059151935, alpha: 1), nil, .darkBackground, .darkBackground),
                ...
                .gridTitle                   : ThemeColor(#colorLiteral(red: 0, green: 0.5690457821, blue: 0.5746168494, alpha: 1), #colorLiteral(red: 0.4756349325, green: 0.4756467342, blue: 0.4756404161, alpha: 1), .darkBackground, .darkBackground),
                ...
                .autoComplete                : ThemeColor(#colorLiteral(red: 0.7843137255, green: 0.7843137255, blue: 1, alpha: 1), #colorLiteral(red: 0.5741485357, green: 0.5741624236, blue: 0.574154973, alpha: 1), .midBackground, .lightBackground),
                .autoCompleteSelected        : ThemeColor(#colorLiteral(red: 0.5882352941, green: 0.5882352941, blue: 1, alpha: 1), #colorLiteral(red: 0.5741485357, green: 0.5741624236, blue: 0.574154973, alpha: 1), .lightBackground, .lightBackground),
                .pickerButton                : ThemeColor(#colorLiteral(red: 0.0166248735, green: 0.4766505957, blue: 0.9990670085, alpha: 1), nil, .darkBackground),
                ...
                .enabledButton               : ThemeColor(#colorLiteral(red: 0.5882352941, green: 0.5882352941, blue: 0.5882352941, alpha: 1), nil, .darkBackground),
                .highlightButton             : ThemeColor(#colorLiteral(red: 0, green: 0.5690457821, blue: 0.5746168494, alpha: 1), nil, .darkBackground),
                .input                       : ThemeColor(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1), #colorLiteral(red: 0.2, green: 0.2, blue: 0.2, alpha: 1), .lightBackground, .lightBackground),
