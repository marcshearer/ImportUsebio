...
class FileSystem {
    ...
    static public func findFile(relativeTo: URL? = nil, prompt: String? = nil, types: [String]? = nil, completion: @escaping (URL, Data)->()) {
#if canImport(AppKit)
    ...
    static public func findDirectory(relativeTo: URL? = nil, prompt: String? = nil, completion: @escaping (URL, Data)->()) {
#if canImport(AppKit)
        let openPanel = NSOpenPanel()
        openPanel.allowsMultipleSelection = false
